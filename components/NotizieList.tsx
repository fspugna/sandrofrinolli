...
export default function NotizieList({ initialNotizie }: { initialNotizie: Notizia[] }) {
    const [notizie] = useState<Notizia[]>(initialNotizie);
                        ...
                        return (
                            <Link key={n._id} href={`/notizie/${n._id}`} className="group flex flex-col h-full bg-[#272833] rounded-2xl overflow-hidden hover:ring-2 hover:ring-blue-500/50 transition-all duration-300">
                                ...
                                <div className="p-8 flex flex-col flex-grow">
                                    ...
                                    <h2 className="text-xl font-serif leading-snug mb-6 group-hover:text-blue-400 transition-colors">{n.titolo}</h2>
